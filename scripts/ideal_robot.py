...
# print('a variable "__name__" of ideal_robot.py is {}'.format(__name__))
# このファイルを import したときに，　if __name__ == '__main__':　以下の処理は実行されない
if __name__ == '__main__':
    # スクリプトとして実行された場合は__name__が__main__になる
    # モジュールとして読み込まれた場合は__name__が__ideal_robot__になる
